...
void SceneManager::RenderHouse()
{
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 0.5f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 1.5f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.0f, 0.25f, -9.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-4.5f, 0.625f, -9.61f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-3.5f, 0.625f, -9.61f);
 ...
 *  This method is called to render the shapes for the House object.
 ***********************************************************/
void SceneManager::RenderHouse2()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(10.0f, 0.5f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(10.0f, 1.5f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(9.61f, 0.25f, -10.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(9.61f, 0.625f, -9.5f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(9.61f, 0.625f, -10.5f);
 ...
 *  This method is called to render the shapes for the House object.
 ***********************************************************/
void SceneManager::RenderHouse3()
{
	// declare the variables for the transformations
	glm::vec3 scaleXYZ;
	float XrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, 0.5f, -8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, 1.5f, -8.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.0f, 0.25f, -7.6f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(10.5f, 0.625f, -7.61f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(11.5f, 0.625f, -7.61f);
